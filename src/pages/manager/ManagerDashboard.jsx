  ...
  return (
    <DashboardLayout role="manager">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <StatCard title="Completed" value="21" accent="text-green-400" />
        <StatCard title="At Risk" value="2" accent="text-red-400" />
      </div>
  ...
  return (
    <div className="flex justify-between items-center bg-surface border border-border rounded-xl p-4">
      <div>
        ...
        <p className="text-sm text-gray-400">Assigned to {assignee}</p>
      </div>
